...
color tc0 = #000000; // black text 
color tc1 = #FFFFFF; // white text
color tc2 = #2183FF; // bg blue text

void setupGUI()
{

  c0 = color(342, 84, 98);//clColor[4]; // item hover/drag/selected - active
  c1 = #FFFFFF; // item background
  c2 = color(174, 95, 90);//clColor[2]; // item - inactive
